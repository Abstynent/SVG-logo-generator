...
// test class function render() for Circle
    describe('Circle', () => {
        it('should return code for .svg file to display a red circle with white "npm" text inside', () => {
            const circle = new Circle("npm", "white", "red");
...
// test class function render() for Triangle
    describe('Triangle', () => {
        it('should return code for .svg file to display a red triangle with white "npm" text inside', () => {
            const circle = new Triangle("npm", "white", "red");
            expect(circle.render()).toBe(`<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><polygon points="150, 18 244, 182 56, 182" fill="red" /><text x="150" y="150" font-size="60" text-anchor="middle" fill="white">npm</text></svg>`)
        })
    })
// test class function render() for Square
    describe('Circle', () => {
        it('should return code for .svg file to display a red circle with "npm" text inside', () => {
            const circle = new Square("npm", "white", "red");
